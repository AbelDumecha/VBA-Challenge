Sub Stock_Data_Part_II()
    ...
    For Each ws In ThisWorkbook.Sheets
        ...
        ws.Cells(summaryRow, summaryColumn + 2).Value = maxPercentageIncrease
        ws.Cells(summaryRow + 1, summaryColumn + 2).Value = minPercentageDecrease
        ws.Cells(summaryRow + 2, summaryColumn + 2).Value = maxTotalVolume
    Next ws
